...
<Steps>
  ...
  <Step title="Add ContactShip">
    ...
    <Tip>
    Don't have your API key? Generate it at [app.contactship.ai/en/organization/api-keys](https://app.contactship.ai/en/organization/api-keys). Requires a plan with API access and permission to manage API keys.
    </Tip>
  </Step>
...
<Tip>
Working with more than one organization? Connect ContactShip once per organization — see [Multiple organizations](/en/mcp/multiple-organizations).
</Tip>
...
<AccordionGroup>
  ...
  <Accordion title="Tools don't respond">
    ...
    If it returns a 401 error, your key is invalid. Generate a new one from the [dashboard](https://app.contactship.ai/en/organization/api-keys).
  </Accordion>
</AccordionGroup>
