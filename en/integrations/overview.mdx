...
<Card title="Connecting your own system?" icon="code" href="/en/integrations/connect-your-system">Choose an API, webhook, or HTTP tool and find the IDs you need.</Card>
