...
<CardGroup cols={2}>
  <Card title="Connect your API" href="/en/integrations/http-tools">Parameters, responses, and testing step by step.</Card>
  <Card title="What your endpoint receives" href="/api-reference/tool-execution">Automatic fields and voice and text JSON bodies.</Card>
</CardGroup>
...
Live execution posts `call`, `tool_name`, and `args` to your endpoint. Configured headers are used by the endpoint test but are not currently forwarded during live execution. Coordinate header-based authentication with support and verify a controlled call.
