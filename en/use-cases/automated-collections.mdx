...
<Steps>
  <Step title="Create a collections agent">
    Go to [Agents](/en/voice-agents/create) and create an agent with clear instructions. For example: *"You are a professional and respectful collections agent. Your goal is to inform the debtor about their outstanding debt and secure a payment commitment with a concrete date. Be firm but empathetic."*
  </Step>
  <Step title="Configure call tags">
    Create [Call Tags](/en/voice-agents/call-tags) like:
  ...
  <Step title="Set up your campaign">
    Go to [Campaigns](/en/calls/campaigns) and create a new campaign. Load your contacts with debt data (amount, concept, due date) as additional fields so the agent can use them in the conversation.
  </Step>
