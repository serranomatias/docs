...
With ContactShip + an automation tool (like [N8N](/en/integrations/n8n) or [Make](/en/integrations/make)), you can trigger an AI call when a new form submission reaches your automation. Configure the calling schedule and check each run for delivery errors.
...
<Steps>
  <Step title="Create your AI agent">
    Go to [Agents](/en/voice-agents/create) and create an agent with qualification instructions. For example: *"You are a sales advisor. Your goal is to understand the lead's needs, qualify them, and schedule a demo meeting."*
  </Step>
  ...
  <Step title="Configure tags (optional)">
    Create [Call Tags](/en/voice-agents/call-tags) like "Interested", "Meeting scheduled", or "Not qualified" so the system notifies you and you can filter results.
  </Step>
...
- Leads contacted through the configured workflow
