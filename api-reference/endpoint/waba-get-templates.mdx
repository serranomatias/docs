...
api: 'GET https://integrations.contactship.ai/api/integrations/waba/templates'
...
<RequestExample>
```bash cURL
curl -X GET "https://integrations.contactship.ai/api/integrations/waba/templates?channel_id=chn_abc123" \
  -H "x-api-key: your-api-key"
```

```bash cURL — With pagination
curl -X GET "https://integrations.contactship.ai/api/integrations/waba/templates?channel_id=chn_abc123&limit=10&after=CURSOR_HERE" \
  -H "x-api-key: your-api-key"
```
...
const response = await fetch(
  `https://integrations.contactship.ai/api/integrations/waba/templates?channel_id=${channelId}`,
...
response = requests.get(
    'https://integrations.contactship.ai/api/integrations/waba/templates',
    headers={'x-api-key': 'your-api-key'},
